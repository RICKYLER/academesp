...
const StudyGroupCard: React.FC<StudyGroupCardProps> = ({ group, onViewDetails }) => {
    ...
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-6 hover:shadow-md transition-shadow touch-manipulation">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 py-3 px-4 rounded-lg font-medium transition-colors touch-manipulation"
        >
          View Details
        </button>
        <button
